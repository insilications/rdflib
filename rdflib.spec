...
%package bin
Summary: bin components for the rdflib package.
Group: Binaries

%description bin
bin components for the rdflib package.


%package python
Summary: python components for the rdflib package.
Group: Default
Requires: rdflib-python3 = %{version}-%{release}

%description python
python components for the rdflib package.


%package python3
Summary: python3 components for the rdflib package.
Group: Default
Requires: python3-core

%description python3
python3 components for the rdflib package.
